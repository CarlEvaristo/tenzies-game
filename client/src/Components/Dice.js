...
export default function Dice(props){
    ...
    return(
        <div 
            ...
            key={!props.isFinished ? new Date().getTime() : false}  // if prop is not finished then give it a unique key => then it gets rendered => else false makes sure react doesnt render the key attr
            >
            {/* <p>{props.value}</p> */}
